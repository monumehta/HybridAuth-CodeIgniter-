...
class Hybrid_Providers_Facebook extends Hybrid_Provider_Model
{
	...
	*/
	...
	{ 
		...
		$fbaccesstoken = $this->api->getAccessTokenFromCodeCustom($_REQUEST['code']);
		...
		if(isset($fbaccesstoken) && !empty($fbaccesstoken)){
			$this->token("access_token",  $fbaccesstoken);
			$this->api->setAccessToken( $this->token("access_token") );
			$this->api->setExtendedAccessToken();
			$access_token = $this->api->getAccessToken();
	...
	*/
	function getUserProfile()
	{
		...
		try{ 
			$data = $this->api->api('/me?fields=email,first_name,last_name'); 
		}
